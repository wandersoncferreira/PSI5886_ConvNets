...
\begin{center}
	...
	\captionof{figure}{ Rede neural simples. Retirado de \cite{livronnet2} }
\end{center} 
...
\begin{center}
	...
	\captionof{figure}{ Norma do vetor de pesos durante o treinamento. Retirada de \cite{livronnet2}}
\end{center}
...
\lstinputlisting[language=Python, firstline=0, lastline=25, basicstyle=\ttfamily\scriptsize]{cnn2.py}
...
\lstinputlisting[language=Python, firstline=0, lastline=25, basicstyle=\ttfamily\scriptsize]{fig.py}
...
\bibitem{dropout} G.E. Hinton et al, \textit{Improving neural networks by preventing co-adaptation of feature detectors}, 2012.
\bibitem{regularization} Anders Krogh e John A. Hertz, \textit{A Simple Weight Decay Can Improve Generalization}
